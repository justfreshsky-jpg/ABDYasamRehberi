...
<link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Ctext y='.9em' font-size='90'%3E%F0%9F%97%BA%3C/text%3E%3C/svg%3E">
<style>
...
<div class="hero">
  ...
  <div class="hero-cta">
    <button data-quickstart="ssn">SSN ile Başla</button>
    <button data-quickstart="vize">Vize Planı</button>
    <button data-quickstart="sorgu">Hızlı Soru Sor</button>
  </div>
</div>
<div class="container">
  <div class="trust-row">
  ...
  <div id="vize" class="tab active"><div class="card">
    ...
    <div class="form-row">
      ...
      <div class="field"><label for="v2">State</label><input id="v2" maxlength="2000" placeholder="örn. New Jersey"></div>
    </div>
  ...
  <div id="rideshare" class="tab"><div class="card">
    ...
    <div class="form-row">
      ...
      <div class="field"><label for="r2">State</label><input id="r2" maxlength="2000" placeholder="New Jersey"></div>
    </div>
  ...
  <div id="saglik" class="tab"><div class="card">
    ...
    <div class="form-row">
      <div class="field"><label for="h1">State</label><input id="h1" maxlength="2000" placeholder="New Jersey"></div>
  ...
  <div id="ehliyet" class="tab"><div class="card">
    ...
    <div class="form-row">
      <div class="field"><label for="l1">State</label><input id="l1" maxlength="2000" placeholder="New Jersey"></div>
...
<div id="ssn" class="tab">
  <div class="card">
    ...
    <div class="form-row">
      ...
      <div class="field">
        ...
        <input id="ss2" maxlength="2000" placeholder="New Jersey">
      </div>
    </div>
    <div class="field">
  ...
  <div id="arac" class="tab"><div class="card">
    ...
    <div class="form-row">
      <div class="field"><label for="ar1">State</label><input id="ar1" maxlength="2000" placeholder="New Jersey"></div>
